...
public class MoscowCoffeShop extends CoffeStore {
    ...
    public void makeAmericano(Coffee americano) {
        ...
        System.out.println(americano.getName() + " готов к выдаче в кофе Москвы. Приятного аппетита!");
    }

    @Override
    public void makeCapuccino(Coffee capuccino) {
        super.makeCapuccino(capuccino);
        System.out.println(capuccino.getName() + " готов к выдаче в кофе Москвы. Приятного аппетита!");
    }

    @Override
    public void makeExpresso(Coffee expresso) {
        super.makeAmericano(expresso);
        System.out.println(expresso.getName() + " готов к выдаче в кофе Москвы. Приятного аппетита!");
    }

    @Override
    public void makeLatte(Coffee latte) {
        super.makeAmericano(latte);
        System.out.println(latte.getName() + " готов к выдаче в кофе Москвы. Приятного аппетита!");
    }
