...
public class SaratovCoffeeStore extends CoffeStore {
    ...
    public void makeAmericano(Coffee americano) {
        ...
        System.out.println(americano.getName() + " готов к выдаче в кофе Саратова. Приятного аппетита!");
    }

    @Override
    public void makeCapuccino(Coffee capuccino) {
        super.makeCapuccino(capuccino);
        System.out.println(capuccino.getName() + " готов к выдаче в кофе Саратова. Приятного аппетита!");
    }

    @Override
    public void makeExpresso(Coffee expresso) {
        super.makeAmericano(expresso);
        System.out.println(expresso.getName() + " готов к выдаче в кофе Саратова. Приятного аппетита!");
    }

    @Override
    public void makeLatte(Coffee latte) {
        super.makeAmericano(latte);
        System.out.println(latte.getName() + " готов к выдаче в кофе Саратова. Приятного аппетита!");
    }
    ...
    public static void selectCoffee(CoffeStore coffeStore) {
        ...
        System.out.println("\nДобро пожаловать, это Саратов. Здесь мы умеем готовить следующие напитки: \n" +
                "1. Американо \n" +
                "2. Капучино \n" +
                "3. Эспрессо \n" +
                "4. Латто \n \n" +
